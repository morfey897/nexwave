	...
	return (
		<div className={clsx('relative text-base', wrapperClassName)}>
			...
			<input
				...
				className={clsx(
					'peer/input w-full py-2 pl-10 pr-4 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300',
					className,
				)}
				type={type || 'text'}
				{...props}
